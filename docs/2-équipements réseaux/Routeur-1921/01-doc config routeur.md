...
⚠️ Attention : après la réinitialisation, penser à remettre le registre de configuration à 0x2102 afin que le routeur puisse charger et enregistrer correctement sa configuration au redémarrage.
```
